      ...
      <nav className="navbar">
        <div className="nav-container">
          <div className="nav-logo">
            <img src={avainweb} alt="avainweb" className="nav-logo-image" />
          </div>
          ...
          <main className="main-sections">
                    ...
                    <div className="about-card">
                      <div className="about-content-new">
                        <div className="about-avatar">
                          <img src={avainweb} alt="我的头像" className="avatar-image" />
                        </div>
                  ...
                  <div className="cards-container">
                    <div className="card cursor-target">
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
                        <img src={p1} alt="Project 1" className="card-image" style={{ width: '80px', height: '80px' }} />
                    ...
                    <div className="card cursor-target">
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
                        <img src={p2} alt="Project 2" className="card-image" style={{ width: '80px', height: '80px' }} />
                    ...
                    <div className="card cursor-target">
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
                        <img src={p3} alt="Project 3" className="card-image" style={{ width: '80px', height: '80px' }} />
                    ...
                    <div className="card cursor-target">
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
                        <img src={p4} alt="Project 4" className="card-image" style={{ width: '80px', height: '80px' }} />
                    ...
                    <div className="card cursor-target">
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
                        <img src={p7} alt="Project 7" className="card-image" style={{ width: '80px', height: '80px' }} />
                    ...
                    <div className="card cursor-target">
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
                        <img src={avainweb} alt="Project 8" className="card-image" style={{ width: '80px', height: '80px' }} />
                    ...
                    <div className="card cursor-target">
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
                        <img src={p5} alt="Project 5" className="card-image" style={{ width: '80px', height: '80px' }} />
                    ...
                    <div className="card cursor-target">
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
                        <img src={p6} alt="Project 6" className="card-image" style={{ width: '80px', height: '80px' }} />
            ...
            <section className="tech-stack-section" ref={techStackRef}>
                ...
                <h2 style={{
                  ...
                  Web Dev ( Striving to become a full stack developer... )
                </h2>
                <div style={{
                  display: 'flex',
                  gap: '40px',
            ...
            <section className="my-interest-section" style={{ marginTop: '4rem', marginBottom: '12rem' }}>
              <div style={{ textAlign: 'left', color: 'white', padding: '2rem 0', maxWidth: '1200px', margin: '0 auto', paddingLeft: '2rem' }}>
                ...
                <div style={{ marginTop: '2rem' }}>
                  ...
                  >
                    AR development, embodied AI, Web3, embedded software development,
                  </ScrollFloat>
                </div>
